...
class StoreDeploymentRequest extends FormRequest
{
    public function authorize(): bool
    {
        ...
        return (bool) $this->user()?->can('create', Deployment::class);
    }
    ...
    {
        return [
            'client_software_id' => ['required', 'integer', 'exists:client_software,id'],
            ...
            'environment_type' => ['required', Rule::enum(MachineEnvironment::class)],
