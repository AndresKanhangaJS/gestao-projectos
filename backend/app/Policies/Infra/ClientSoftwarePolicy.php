...
class ClientSoftwarePolicy
{
    ...
    public function view(User $user, ClientSoftware $clientSoftware): bool
    {
        return $this->canReadInfra($user);
    }
    ...
    public function update(User $user, ClientSoftware $clientSoftware): bool
    {
        return $this->canWriteInfra($user);
    }

    public function delete(User $user, ClientSoftware $clientSoftware): bool
    {
        return $this->canWriteInfra($user);
    }
}
