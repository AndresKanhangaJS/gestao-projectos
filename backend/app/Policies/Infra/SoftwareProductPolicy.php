...
class SoftwareProductPolicy
{
    ...
    public function view(User $user, SoftwareProduct $softwareProduct): bool
    {
        return $this->canReadInfra($user);
    }
    ...
    public function update(User $user, SoftwareProduct $softwareProduct): bool
    {
        return $this->canWriteInfra($user);
    }

    public function delete(User $user, SoftwareProduct $softwareProduct): bool
    {
        return $this->canWriteInfra($user);
    }
}
