...
class SoftwareModulePolicy
{
    ...
    public function view(User $user, SoftwareModule $softwareModule): bool
    {
        return $this->canReadInfra($user);
    }
    ...
    public function update(User $user, SoftwareModule $softwareModule): bool
    {
        return $this->canWriteInfra($user);
    }

    public function delete(User $user, SoftwareModule $softwareModule): bool
    {
        return $this->canWriteInfra($user);
    }
}
