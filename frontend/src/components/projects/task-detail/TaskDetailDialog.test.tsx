...
vi.mock('@/api/projects', () => ({
  getProject: vi.fn().mockResolvedValue({ id: 1, workspace_id: 5, key: 'LS', name: 'Level', status: 'active' }),
}))
vi.mock('@/api/workspaces', () => ({
  getWorkspace: vi.fn().mockResolvedValue({ id: 5, name: 'WS', members: [{ id: 1, name: 'Ana Admin' }] }),
}))
...
describe('TaskDetailDialog', () => {
  ...
  it('lista as subtarefas com o seu estado', async () => {
    ...
    expect(screen.getByRole('button', { name: /seguir/i })).toHaveAttribute('aria-pressed', 'false')
  })
})
