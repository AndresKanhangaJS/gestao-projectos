...
export const SoftwareProductDetailPage = lazy(() => import('@/pages/infra/SoftwareProductDetailPage'))
...
export function LazyPage({ component: Component }: { component: LazyExoticComponent<ComponentType> }) {
  return (
